...
CARDS: List[Card] = [
    ...
    Card("Light blue",      Color("#0088ff"), (17, 30, 20,  7,  1, 12, 25,  8, 29)),    # noqa
    Card("Light yellow",    Color("#ffff80"), (14,  8,  2, 23, 11, 25,  4, 29, 17)),    # noqa
    Card("Green",           Color("#008800"), (16,  2, 19, 28,  9, 23, 12,  7, 30)),    # noqa
    Card("Purple",          Color("#880088"), (12, 24,  3,  5, 16, 21, 20, 27,  8)),    # noqa
    Card("Yellow",          Color("#cccc00"), (26, 22,  7,  1, 17, 27, 13, 20, 10)),    # noqa
    Card("Gray",            Color("#888888"), ( 9, 14,  6, 22,  4, 15, 30, 18, 26)),    # noqa
    Card("Blue",            Color("#00ffff"), (15,  3, 23, 25,  6, 11, 18, 28,  5)),    # noqa
    Card("Orange",          Color("#ffaa00"), ( 5, 16, 19, 21,  2, 13, 26, 10, 24))     # noqa
]
